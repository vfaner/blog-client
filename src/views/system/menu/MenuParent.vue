...
import useMenuParent from "@/composables/nav/useMenuParent";
...
//树相关数据
const {treeData, defaultProps, handleNodeClick, getTreeData, openBtn, parentTree, selectNode} = useMenuParent();
